        ...
        <div class="container mx-auto px-6 py-6">
            ...
            <div class="flex flex-col md:flex-row items-center justify-between">
                ...
                <div class="flex flex-wrap justify-center gap-4">
                    ...
                    <button @click="emit('header-action', 'design')" :class="[
                        'group backdrop-blur-md rounded-xl p-4 flex items-center gap-3 transition-all duration-300 shadow-lg hover:shadow-xl',
                        isDarkMode 
                            ? 'bg-gray-700/50 hover:bg-gray-600/70' 
                            : 'bg-white/50 hover:bg-white/70'
                    ...
                    <button @click="emit('header-action', 'preview')" :class="[
                        'group backdrop-blur-md rounded-xl p-4 flex items-center gap-3 transition-all duration-300 shadow-lg hover:shadow-xl',
                        isDarkMode 
                            ? 'bg-gray-700/50 hover:bg-gray-600/70' 
                            : 'bg-white/50 hover:bg-white/70'
                    ...
                    <button @click="emit('header-action', 'export')" :class="[
                        'group backdrop-blur-md rounded-xl p-4 flex items-center gap-3 transition-all duration-300 shadow-lg hover:shadow-xl',
                        isDarkMode 
                            ? 'bg-gray-700/50 hover:bg-gray-600/70' 
                            : 'bg-white/50 hover:bg-white/70'
            ...
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center gap-3">
                    <div :class="[
                        ...
                        <Icon icon="material-symbols:info" :class="[
                            'text-xl',
